...
- v3 - opensouce analytics library for data  
- v4 - Application - Cron job (linux (shell script) & window (bash script) version and Terminal menu options w/ commandline arguments 
...
- v6 - Make a frontend UI consumer to interact with backend (SQL & )
